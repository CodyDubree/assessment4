...
class School {
    ...
    School(name: "TTYS", numberOfStudents: 3567, publicOrPrivate: "Public", yearBuilt: 1845)
    
   
    }
    func schoolDescription() {
        print("\(name), was founded in \(yearBuilt), and has \(numberOfStudents) in attendance.")
        print(schoolDescription())
    }
